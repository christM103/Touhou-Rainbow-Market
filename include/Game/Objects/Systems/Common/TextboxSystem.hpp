...
namespace TR {
	...
	public:
		...
		void init(const Engine::EntityManager* entityManager, const Engine::ComponentManager* componentManager);
	...
	private:
		std::deque<Engine::Entity> _textbox_entities{ }; // Set of renderable entities
